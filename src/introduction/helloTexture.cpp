...
int main()
{
	...
	Shader ourShader("../../../src/shader/helloTexture.vert", "../../../src/shader/helloTexture.frag");
	...
	//set texture wrapping paramenters
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
	//set texture filtering paraments
	...
	if (data)
	{
		...
		std::cout << "load texture image success" << std::endl;
	}
	else
	{
